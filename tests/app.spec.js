...
describe("app test", () => {
  ...
  it("should test that required user pref body is missing for creating user pref", async () => {
    ...
    expect(response.body).toEqual({
      code: httpStatus.BAD_REQUEST,
      message:
        "Web language is required, Communication language is required, Braille/TTY is required, Preferred Currency Code is required, Time Zone is required, Time Format Code is required",
    });
  });
